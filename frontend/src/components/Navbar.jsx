...
import { Star, User, Eye, EyeSlash} from "@phosphor-icons/react";
        ...
        <header className="w-full bg-bg-secondary sticky top-0 z-40">
            <div className="w-11/12 max-w-[1200px] mx-auto flex justify-between items-center py-2">
                ...
                {authenticated?<nav className="flex gap-4 items-center">
                        <Link to="/buy-credit" className="flex items-center gap-2 text-white bg-btn-primary hover:scale-105 duration-300 px-4 py-2 rounded-full"><Star size={20} />Credits left:{creditsRemaining}</Link>
