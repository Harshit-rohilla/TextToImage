            ...
            <main className="flex-1 flex justify-center items-center">
                ...
                :<form onSubmit={handleSubmit(submitForm)} className="md:w-md bg-white px-6 pt-4 pb-10 flex flex-col rounded-md gap-4 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
                    ...
                    <div className="relative">
                        <input {...register("newPassword")} minLength={6} placeholder="New Password" type={isPasswordVisible?"text":"password"} className="pl-4 pr-10 py-2 text-text-primary border-[1px] border-text-primary w-full rounded-full" />
                    ...
                    <div className="relative">
                        <input {...register("confirmPassword")} minLength={6} placeholder="Confirm Password" type={isPasswordVisible2?"text":"password"} className="pl-4 pr-10 py-2 text-text-primary border-[1px] border-text-primary w-full rounded-full" />
